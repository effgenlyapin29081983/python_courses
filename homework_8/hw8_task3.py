class MyException(Exception):
    ...
    def __init__(self, num, List):
        ...
        elif not num.isdigit() and not num == "stop":
            print("not numeric!!!")
        elif not num.isdigit() and num == "stop":
            print(List)
            exit()
try:
    myList=[]
    while True:
        MyException(input("Enter num:\n"), myList)
except MyException as myex:
    print(myex)
# Честно говоря все работает корректно, но не понимаю смысла в данной ситуации использовать класс исключение?
